...
slider = createSlider(0.0, 1.0, 0.5);
...
//reverb.process(polySy, 60, 13);
 ...
 // distortion = new p5.Distortion( 0.90,'1x');

 // distortion.process(polySy,mouseY, '1x');
...
function playSynth() {
 ...
 let velocity = (slider.value());
  let getAmp = (slider.value());
